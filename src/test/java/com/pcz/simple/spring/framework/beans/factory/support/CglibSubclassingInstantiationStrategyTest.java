...
public class CglibSubclassingInstantiationStrategyTest {
    private CglibSubclassingInstantiationStrategy cglibSubclassingInstantiationStrategy;

    @BeforeEach
    public void setUp() {
        cglibSubclassingInstantiationStrategy = new CglibSubclassingInstantiationStrategy();
    }
    ...
    public void should_instantiate() throws NoSuchMethodException {
        ...
        Object result = cglibSubclassingInstantiationStrategy.instantiate(beanDefinition, beanName, constructor, args);
        Assertions.assertThat(result).isNotNull();
    }

    @Test
    public void should_instantiate_to_instantiate_when_constructor_is_null_and_default_constructor_exists() {
        String beanName = "foo";
        BeanDefinition beanDefinition = new BeanDefinition(Foo.class);

        Object result = cglibSubclassingInstantiationStrategy.instantiate(beanDefinition, beanName, null, null);
        Assertions.assertThat(result).isNotNull();
    }
    ...
    public void should_throw_beans_exception_to_instantiate_when_args_not_match() throws NoSuchMethodException {
        ...
        Assertions.assertThatExceptionOfType(BeansException.class)
                .isThrownBy(() -> {
                    cglibSubclassingInstantiationStrategy.instantiate(beanDefinition, beanName, constructor, args);
                });
    }
    ...
    public void should_throw_beans_exception_to_instantiate_when_bean_definition_is_null() {
        ...
        Assertions.assertThatExceptionOfType(BeansException.class)
                .isThrownBy(() -> {
                    cglibSubclassingInstantiationStrategy.instantiate(null, beanName, null, null);
                });
    }
